...
export function buildThemePrompt({ request, current }: { request: string; current: ThemeSpec | null }): string {
  ...
  return [
    ...
    '  saturation 1-2 (liquid glass about 1.8), highlight 0-1 (bright rim and sheen; liquid glass 0.7-1), refraction 0-1 (edges bend what is',
    '  behind them like a lens; liquid glass 0.4-0.7, frosted 0). Apiary thickens any pane whose text would be hard to read.',
